...
import { Mail, User, Eye, EyeOff, Lock, ArrowLeft } from "lucide-react";

const Signup = ({ API_URL = import.meta.env.VITE_API_URL ||"https://expense-tracker-dcne.onrender.com", onSignup }) => {
  ...
  const persistAuth = (profile, token) => {
    ...
    try {
      ...
      console.error("Error persisting authentication data:", error);
    }
  };
  ...
  const handleSubmit = async (e) =>{
    ...
    try {
      ...
      if (typeof onSignup === "function") {
        try {
          onSignup(profile, token, rememberMe);
        } catch (callErr) {
    ...
    <div className={signupStyles.pageContainer}>
      <div className={signupStyles.cardContainer}>
        <div className={signupStyles.header}>
          ...
          <h1 className={signupStyles.headerTitle}>Create an Account</h1>
