...
// helper function to convert date to ISO string with client time
...
const Income = () => {
  ...
  // helper function to check if a date is within the selected time frame range or not
  ...
  // handle edit income transaction
  ...
  // handle delete income transaction
  ...
  // handle export income transactions to Excel
